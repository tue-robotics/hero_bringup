...
for launch_file in ${launch_files}; do
    ...
    install_services_cmd="$install_services_cmd && echo 'Creating /etc/systemd/system/$name.service' && rosrun ${bringup_name}_bringup systemd_service_from_launch_file ${launch_file} amigo ~/.tue/setup.bash | sudo tee /etc/systemd/system/$name.service"
done
